...
struct decimator:Codable {
    ...
    struct amp1:Codable {
        ...
        static var delayMix: Double = 0.1 // (Normalized Value) ranges from 0 to 1 (Default: 0.5)
        ...
        static var linearTerm: Double = 0.1 // (Normalized Value) ranges from 0 to 1 (Default: 0.5)
        static var squaredTerm: Double = 0.1 // (Normalized Value) ranges from 0 to 1 (Default: 0.5)
        static var cubicTerm: Double = 0.1 // (Normalized Value) ranges from 0 to 1 (Default: 0.5)
        static var polynomialMix: Double = 0.1 // (Normalized Value) ranges from 0 to 1 (Default: 0.5)
        ...
        static var ringModBalance: Double = 0.1 // (Normalized Value) ranges from 0 to 1 (Default: 0.5)
